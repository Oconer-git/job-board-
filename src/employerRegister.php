                ...
                <div id = "RegForm">
                    <div class= "formReg">
                        ...
                        <div class="input-control-reg">
                            ...
                            <input minlength="8" type="tel" name="phoneNumber" placeholder= "phone number" class="input-field" value="+639" maxlength="13" minlength="13" required>
                        </div>

                        <div class="input-control-reg">
                            <input minlength="8" type="text" name="businessName" placeholder="Business Name" class="input-field" minlength="8" required>&nbsp;&nbsp;&nbsp;&nbsp;
